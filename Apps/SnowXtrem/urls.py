...
urlpatterns = [
    ...
    path('password_change/', PasswordChangeView.as_view(
        template_name='snowxtrem/password_change_form.html'), name='password_change'),
    path('password_change/dond/', PasswordChangeDoneView.as_view(template_name='snowxtrem/password_change_done.html'),
    ...
    path('reset/<uidb64>/<token>/', PasswordResetConfirmView.as_view(
        ...
        success_url=reverse_lazy('snowxtrem:login')), name='password_reset_confirm'),
